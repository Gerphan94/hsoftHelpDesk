                                        ...
                                        <div className="h-auto min-h-[120px] resize-none w-full border p-2"
                                            ...
                                            {kpi.dieukien.map((ele) =>
                                                <div className="flex gap-2 mb-1">
                                                    <div className="w-1/2 text-left">{ele.name}</div>
                                                    <div className="w-1/4">{ele.selectedOption}</div>
                                                    <div className="w-1/4 border">{ele.value}</div>
                                                </div>
                                            )}
                                        </div>
                                    </td>
                                        ...
                                        <div className="p-4 border min-h-28">
                                            {kpi.ketqua.map((ele) =>
                                                <div className="flex gap-2 mb-1">
                                                    ...
                                                    <input
                                                        type="number"
                                                        className="w-16 border outline-none px-2 bg-orange-100"
                                                        style={{ '-moz-appearance': 'textfield', '::-webkit-inner-spin-button': 'display: none', '::-webkit-outer-spin-button': 'display: none' }}
                                                        value={ele.value}
                                                    />
                                                </div>
                                            )}
